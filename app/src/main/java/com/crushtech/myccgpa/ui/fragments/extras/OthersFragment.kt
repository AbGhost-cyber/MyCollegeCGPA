...
import com.crushtech.myccgpa.databinding.ExtrassLayoutBinding
...
@AndroidEntryPoint
class OthersFragment : BaseFragment(R.layout.extrass_layout) {
    private var binding: ExtrassLayoutBinding by viewLifecycle()
    ...
    override fun onCreateView(
        ...
        binding = ExtrassLayoutBinding.inflate(inflater, container, false)
        return binding.root
    }
...
//        )
    ...
    private fun setUpGroupItemsData() {
        ...
        groupAdapter!!.apply {
            accountingItemAdapter.differ.submitList(accountItemsList!!)
