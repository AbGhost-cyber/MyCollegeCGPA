...
import com.crushtech.myccgpa.dialogs.ItemNotOwnedDialogFragment
...
import com.crushtech.myccgpa.utils.Constants.customRecyclerViewScrollListener
import com.crushtech.myccgpa.utils.Constants.getCurrentUserName
import com.crushtech.myccgpa.utils.Constants.setupDecorator
                ...
                when (result.status) {
                    Status.SUCCESS -> {
                        ...
                        (activity as MainActivity)
                            .activityMainBinding.mainActivityTransBg.visibility = GONE
                        showSnackBar(
                    ...
                    Status.LOADING -> {
                        (activity as MainActivity)
                            .activityMainBinding.mainActivityTransBg.visibility = VISIBLE
